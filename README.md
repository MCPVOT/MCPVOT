...
[Live](https://pequi-lyart.vercel.app) · `Next.js 15` `React 19` `TypeScript` `Prisma` `PostgreSQL` `Clerk` `Vercel`
...
| **Automation** | MCP Servers · A2A (Agent-to-Agent) · DGM (self-evolving engine) · n8n Workflows · GitHub Actions CI/CD |
